    ...
    return <div className='resource-info'>
        ...
        <div className='flex-column'>
            <div className='flex-row' style={{ justifyContent: 'space-between', margin: '10px 0px' }}>
                <div>命名资源统计：<Select options={[]} style={{ width: '240px' }} size='small'></Select></div>
                <div >搜索：<Input size='small'></Input></div>
            </div>
            <div className={`resource-info-wrapper flex-row`} style={{ flexWrap: 'wrap' }}>
                <CardItem />  <CardItem />  <CardItem />  <CardItem />  <CardItem />  <CardItem />  <CardItem />  <CardItem />  <CardItem />  <CardItem />  <CardItem />  <CardItem />  <CardItem />
            </div>
        </div>
    </div>
}
