      ...
      dataSource: [
        {
          ...
          env: 'prod',
          releaseBranch: 'release_prod_2021042743301321',
          features:
            'feature_lilan-test01_2021042742071221,feature_lilan-test02_2021042743161621',
          unMergedFeatures: '',
          conflictFeature: 'feature_lilan-test02_2021042743161621',
          mergeWebUrl:
            'http://gitlab.cfuture.shop/devops/cops-appmanagement/-/merge_requests/1518',
          ...
          createUser: '李澜',
          modifyUser: '李澜',
          gmtCreate: '2021-04-27T15:30:23+08:00',
          gmtModify: '2021-04-27T15:33:59+08:00',
        },
      ],
      pageInfo: {
        pageIndex: 1,
