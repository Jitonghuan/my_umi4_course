...
export default [
    ...
    "routes": [
      ...
      },
      {
        ...
        "routes": [
          ...
          },
          {
            ...
            "key": "project-environment",
            "hideInMenu": true,
            "component": "@/pages/application/project-environment/environment-deploy/components/deploy-info/container-info"
          },
          {
      ...
      },
      {
        ...
        "routes": [
          ...
          {
            "path": `${baseRoutePath}/application/npm-detail/version`,
            "name": "部署",
            "hideInMenu": true,
  ...
  },
  {
    ...
    "routes": [
      ...
      {
        "path": `${baseRoutePath}/ticket/alarm`,
        "name": "告警工单",
        "key": "ticketAlarm",
        "component": "@/pages/ticket/ticket-alarm"
      },
      {
        "path": `${baseRoutePath}/ticket/addTicket`,
        "name": "新建工单",
        "key": "addTicket",
      ...
      {
        "path": `${baseRoutePath}/ticket/resourceApply`,
        "name": "资源申请",
        "key": "resourceApply",
  ...
  },
  {
    ...
    "routes": [
      ...
      {
        "path": `${baseRoutePath}/admin/message`,
        "name": "消息管理",
        "key": "message",
