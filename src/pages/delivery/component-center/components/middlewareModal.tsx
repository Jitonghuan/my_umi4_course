  ...
  return (
    ...
    >
      <Form form={form} labelCol={{ flex: '120px' }}>
        <Form.Item label="组件名称" name="envCode" rules={[{ required: true, message: '请选择应用类型' }]}>
          <Select style={{ width: 320 }}></Select>
        </Form.Item>
        <Form.Item label="组件版本" name="comPonentName" rules={[{ required: true, message: '请选择应用类型' }]}>
          <Select style={{ width: 320 }}></Select>
        </Form.Item>

        <Form.Item label="组件描述" name="envCode" rules={[{ required: true, message: '请选择应用类型' }]}>
