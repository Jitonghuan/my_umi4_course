    ...
    data: {
      ...
      plans: [
        ...
        },
        {
          ...
          DML: "alter table biz_outpatient_settle_master add COLUMN voucher_status tinyint(4) DEFAULT null comment '医保结算清单上传状态 1 待审核  2 已审核    3上传中  4 已上传   5 上传失败 6撤销中 7已撤销  8 撤销失败';\n",
          develop: '徐佳栋',
          test: '木一',
          deploy: '徐佳栋',
        ...
        },
        {
          ...
          DML: "alter table biz_inhospital_settle_master add COLUMN voucher_status tinyint(4) DEFAULT null comment '医保结算清单上传状态 1 待审核  2 已审核    3上传中  4 已上传   5 上传失败 6撤销中 7已撤销  8 撤销失败';\n",
          develop: '徐佳栋',
          test: '木一',
          deploy: '徐佳栋',
          preDeployTime: '2021-04-29 18:00',
