...
export const getColor = (value: any, type: string) => {
  ...
  if (type === 'cpu') {
    ...
    if (value > 80 && value < 90) { return '#d0c669' }
  }
  //内存
  if (type === 'wss') {
    if (value > 95) { return 'red' }
    if (value > 80 && value < 95) { return '#d0c669' }
  }
  // 平均RT
  if (type === 'rt') {
    if (value > 5000) { return 'red' }
    if (value > 1000 && value < 5000) { return '#d0c669' }
  }
  // 成功率
  if (type === 'sr') {
    if (value < 90 && value !== 0) { return '#d0c669' }
  }
  return ''
...
export const createTableColumns = (params: {
  ...
  return [
    ...
    },
    {
      ...
      key: 'svcCpuRate',
      width: 90,
      render: (value) => <span style={{ color: getColor(value, 'cpu') }}>{value || 0}% </span>,
      sorter: {
    ...
    },
    {
      ...
      key: 'svcWssRate',
      width: 100,
      render: (value) => <span style={{ color: getColor(value, 'wss') }}>{value}% </span>,
      sorter: {
    ...
    },
    {
      ...
      key: 'svcAvg',
      width: 110,
      render: (value) => <span style={{ color: getColor(value, 'rt') }}>{value}</span>,
      sorter: {
    ...
    },
    {
      ...
      key: 'svcSR',
      width: 110,
      render: (value) => <span style={{ color: getColor(value, 'sr') }}>{value}% </span>,
      sorter: {
