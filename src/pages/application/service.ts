...
/** POST 新建分支关联需求 */
export const queryPortalList = `http://kapi-base-prod.cfuture.shop/eip-demand/portal/list`;

export const getDemandByProjectList = `http://kapi-base-prod.cfuture.shop/eip-demand/portal/getDemandByProject`;
