        ...
        <Form form={form} labelCol={{ flex: '120px' }}>
          ...
          {type == 2 && (
            <>
              ...
              <Row>
                <Col span={10}>
                  <Form.Item label="类型" name="leixing">
                    <Select options={[]} />
                  </Form.Item>
                </Col>
                <Col span={10}>
                  <Form.Item label="名称" name="mingcheng">
                    <Select options={[]} />
                  </Form.Item>
                </Col>
              </Row>
              <Row>
                <Col span={10}>
                  <Form.Item label="操作" name="caozuo">
                    <Select options={[]} />
                  </Form.Item>
                </Col>
                <Col span={10}>
                  ...
                  <>
                    {fields.map((field) => (
                      <Space key={field.key} align="baseline">
                        ...
                        <Form.Item {...field} className="tag-value" label="VALUE" name={[field.name, 'value']}>
                          <Input size="small" />
                        </Form.Item>
                        <Form.Item>
