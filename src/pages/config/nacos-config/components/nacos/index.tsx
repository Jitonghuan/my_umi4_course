...
import { Form, Input, Modal, Button ,Space,Table,Spin,Empty,Upload,message,Select} from 'antd';
    ...
    const getTableSource = () => {
        ...
        getNacosNamespaces(envCode || "").then((res) => {
          ...
          if (typeIndex !== -1) {
           ...
           getNacosConfigDataSource({namespaceId:data[1]?.namespaceId})
          } else {
            setNamespaces(res)
            setCurNamespace(res[0]?.namespaceShowName)
            setCurNamespaceData(res[0])
            setIsClick(res[0]?.namespaceShowName);
            getNacosConfigDataSource({namespaceId:res[0]?.namespaceId})
          }
        }).finally(() => {
          setLoading(false)
        })
                            ...
                            return(
                                ...
                                <span 
                                 ...
                                 onClick={()=>{
                                    ...
                                    getNacosConfigDataSource({namespaceId:item?.namespaceId})
                                 }}
            ...
            {curNamespace&&(<>
                ...
                <div className="nacos-table">
                  ...
                  <div className="nacos-table-footer">
                        ...
                        <Space>
                            <Button danger loading={delLoading} onClick={()=>{
                                  let params=form.getFieldsValue()
