          ...
          tags: [
            {
              key: 'url',
              value:
                'http://nacos-headless.hbos-test.svc.cluster.local:8848/nacos/v1/cs/configs?dataId=&group=bdp-registry&pageNo=1&pageSize=1000&tenant=bdp-hbos&search=accurate',
            },
            {
              key: 'http.method',
              value: 'GET',
