...
export default [
  ...
  {
    path: `${baseRoutePath}/operation/cluster-zy`,
    redirect: `${baseRoutePath}/operation/cluster-zy/dashboards`,
  },
  {
    path: `${baseRoutePath}/operation/cluster-tt`,
    redirect: `${baseRoutePath}/operation/cluster-tt/dashboards`,
  },
  {
    ...
    routes: [
      {
        path: 'cluster-zy',
        name: '浙一双集群管理',
        key: 'operation-cluster-zy',
        component: '@/pages/operation/cluster-zy',
        routes: [
          {
            path: 'dashboards',
            name: '集群看板',
            key: 'operation-cluster-zy',
            component: '@/pages/operation/cluster-zy/dashboards',
            hideInMenu: true,
          },
          {
            path: 'scheduling',
            name: '流量调度',
            key: 'operation-cluster-zy',
            component: '@/pages/operation/cluster-zy/scheduling',
            hideInMenu: true,
          },
          {
            path: 'cluster-sync',
            name: '集群同步',
            key: 'operation-cluster-zy',
            component: '@/pages/operation/cluster-zy/cluster-sync',
            hideInMenu: true,
          },
          {
            ...
            name: '集群同步',
            key: 'operation-cluster-zy',
            component: '@/pages/operation/cluster-zy/cluster-sync/sync-detail',
            hideInMenu: true,
          },
          {
            ...
            name: '应用同步',
            key: 'operation-cluster-zy',
            component: '@/pages/operation/cluster-zy/application-sync',
            hideInMenu: true,
          },
          {
            path: 'operation-log',
            name: '操作记录',
            key: 'operation-cluster-zy',
            component: '@/pages/operation/cluster-zy/operation-log',
            hideInMenu: true,
          },
        ],
      },
      {
        path: 'cluster-tt',
        name: '天台双集群管理',
        key: 'operation-clusterTt',
        component: '@/pages/operation/cluster-tt',
        routes: [
          {
            path: 'dashboards',
            name: '集群看板',
            key: 'operation-clusterTt',
            component: '@/pages/operation/cluster-tt/dashboards',
            hideInMenu: true,
          },
          {
            path: 'scheduling',
            name: '流量调度',
            key: 'operation-clusterTt',
            component: '@/pages/operation/cluster-tt/scheduling',
            hideInMenu: true,
          },
          {
            path: 'cluster-sync',
            name: '集群同步',
            key: 'operation-clusterTt',
            component: '@/pages/operation/cluster-tt/cluster-sync',
            hideInMenu: true,
          },
          {
            path: 'cluster-sync-detail',
            name: '集群同步',
            key: 'operation-clusterTt',
            component: '@/pages/operation/cluster-tt/cluster-sync/sync-detail',
            hideInMenu: true,
          },
          {
            path: 'application-sync',
            name: '应用同步',
            key: 'operation-clusterTt',
            component: '@/pages/operation/cluster-tt/application-sync',
            hideInMenu: true,
          },
          {
            path: 'operation-log',
            name: '操作记录',
            key: 'operation-clusterTt',
            component: '@/pages/operation/cluster-tt/operation-log',
            hideInMenu: true,
          },
        ],
      },
